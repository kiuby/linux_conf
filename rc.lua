...
-- {{{ Tags
tags = {
   names = { "main", "edit", "web", "web2", "mail", "media", "music", "other" },
   layout = { layouts[1], layouts[3], layouts[4], layouts[1], layouts[7], layouts[1], layouts[2], layouts[5] }
}
...
globalkeys = awful.util.table.join(
    ...
    --Custom param : don't need it right now!!!
...
-- Start client on specific tags

-- Set my mapping
    --{ rule = { class = "Firefox" },
     -- properties = {tag = tags[1][3]}},

    -- in order to have 2 navigator in 2 layout different
